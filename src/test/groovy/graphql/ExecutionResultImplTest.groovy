...
class ExecutionResultImplTest extends Specification {
    ...
    def EXPECTED_SPEC_ERRORS = [['message': 'Yikes', 'locations': [[line: 666, column: 664]], extensions:[errorCode:"InvalidSyntax"]]]
    ...
    def "test add error building "() {
        ...
        specMap.size() == 1
        specMap["errors"] == [
                ['message': 'Yikes', 'locations': [[line: 666, column: 664]], extensions:[errorCode:"InvalidSyntax"]],
                ['message': 'Yowza', 'locations': [[line: 966, column: 964]], extensions:[errorCode:"InvalidSyntax"]]
        ]
    }
